    ...
    for file_name in file_names:
        ...
        with rasterio.open(file_path) as src:
            ...
            if invalid_mask is None:
                invalid_mask = create_invalid_mask(tif_data)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/data_gen_3/huc_code_data_znorm_128/', help="Output directory for the text files and patches")
