...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/data_gen_2/huc_code_data_znorm_128/', help="Output directory for the text files and patches")
