...
def plot_patch_channels(huc_code, X_test_patch, y_pred_patch, y_test_patch, save_path, channels):
    ...
    ncols = (num_channels + 2 + nrows - 1) // nrows  # Calculate the number of columns dynamically
...
def evaluate_model(model, best_model_save_path, csv_path, data_dir, normalization_type, save_path, project_name, run_name, scenario, channels):
    ...
    for huc_code in huc_codes_list:
        ...
        if X_test.shape[0] >= 50:
            X_test_10th_patch = X_test[50]   # 51th input patch
            y_pred_10th_patch = y_pred[50]   # 51th prediction
            y_test_10th_patch = y_test[50]   # 51th label
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/w_254_255/model/maml_3_500_1_20241203_160002/maml_model.keras', help='meta-learning model')
    parser.add_argument('--model_save_path', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/w_254_255/model/maml_3_500_1_20241203_160002/', help='Path to save adapted models')
    parser.add_argument('--eval_save_paths', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/w_254_255/model/maml_3_500_1_20241203_160002/eval_adapt_results/', help='Path to save evaluations')
