...
# Set the job name
#SBATCH --job-name=deeperUnet_w_254_255
# Set the partition
...
# Set the output file
#SBATCH --output=logs/maml_w_254_255_deeperUnet_%j.txt
...
# Set variables
model="deeperUnet"
save_path="/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/deeper_unet_w_254_255/model"
wandb_project_name="alaska_w_254_255_deeperunet"
