...
import datetime
import wandb
from libs.attentionUnet import AttentionUnet, ChannelAttention, SpatialAttention
...
def plot_patch_channels(huc_code, X_test_patch, y_probs_patch, y_pred_patch, y_test_patch, save_path, channels):
...
def evaluate_model(model, best_model_save_path, csv_path, data_dir, normalization_type, save_path, project_name, run_name, scenario, channels):
    ...
    for huc_code in huc_codes_list:
        ...
        indx = 20
        if X_test.shape[0] >= indx:
            X_test_patch = X_test[indx]
            y_pred_probs_patch = y_pred_probs[indx]
            y_pred_patch = y_pred[indx]
            y_test_patch = y_test[indx]
            
            # Save the plot of the 10th patch channels, prediction, and label
            plot_filename = os.path.join(save_path, f'{huc_code}.png')
            plot_patch_channels(huc_code, X_test_patch, y_pred_probs_patch, y_pred_patch, y_test_patch, plot_filename, channels)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/maml_sum_task_losses/model/maml_3_500_1_20241212_113605/maml_model.keras', help='meta-learning model')
    parser.add_argument('--model_save_path', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/maml_sum_task_losses/model/maml_3_500_1_20241212_113605/', help='Path to save adapted models')
    parser.add_argument('--eval_save_paths', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/maml_sum_task_losses/model/maml_3_500_1_20241212_113605/', help='Path to save evaluations')
    ...
    parser.add_argument('--wandb_project', type=str, default="alaska_wo_254_255_unet_12122024_1132", help='WandB project name for logging')
    ...
    parser.add_argument('--inner_steps', type=int, default=500, help='Number of adaptation steps')
