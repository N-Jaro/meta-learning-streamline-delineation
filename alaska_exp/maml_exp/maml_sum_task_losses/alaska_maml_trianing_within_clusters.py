...
def maml_training(base_model, episodes, config):
    ...
    for epoch in range(config['epochs']):
        ...
        mean_loss = tf.reduce_sum(task_losses) # This emphasizes tasks with higher losses, potentially giving them more weight in the meta-update.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/maml_sum_task_losses/model', help='Path to save trained models')
    parser.add_argument('--wandb_project_name', type=str, default='alaska_wo_254_255_unet_12122024_1132', help='Path to save trained models')
