...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/wo_254_255/model/maml_3_500_1_20241205_141236/maml_model.keras', help='meta-learning model')
    parser.add_argument('--model_save_path', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/wo_254_255/model/maml_3_500_1_20241205_141236/', help='Path to save adapted models')
    parser.add_argument('--eval_save_paths', type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/maml_exp/wo_254_255/model/maml_3_500_1_20241205_141236/eval_adapt_results/', help='Path to save evaluations')
    ...
    parser.add_argument('--wandb_project', type=str, default="alaska_wo_254_255_unet_12052024_0204", help='WandB project name for logging')
