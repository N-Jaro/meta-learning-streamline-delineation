...
def preprocess_label_tif(tif_data):
    """onyl take 1 as the stream pixels."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/experiment_w_mask/data_w_mask/huc_code_data_only_1/', help="Output directory for the text files and patches")
