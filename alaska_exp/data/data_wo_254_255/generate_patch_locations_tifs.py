...
def preprocess_label_tif(tif_data):
    """Only take 1 as stream we do not use 254 and 255"""
...
def normalize_tif(tif_data):
    ...
    tif_data[tif_data == -9999] = mean_val
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default='/u/nathanj/meta-learning-streamline-delineation/alaska_exp/data/data_wo_254_255/huc_code_data_znorm_128', help="Output directory for the text files and patches")
