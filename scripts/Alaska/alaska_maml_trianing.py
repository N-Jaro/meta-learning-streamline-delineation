...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='attentionUnet', choices=['unet', 'attentionUnet'], help='Model architecture')
    parser.add_argument('--meta_lr', type=float, default=0.013, help='Meta learning rate')
    parser.add_argument('--inner_lr', type=float, default=0.027, help='Inner loop learning rate')
